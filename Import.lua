...
step
	...
	+Right now the Turn In guide is not out yet, keep an eye on our community discord to keep up to date
step << skip
...
step << Alliance
    ...
    .collect 31363,1,10797,1 --Collect Gorgrom's Favor (x1)
...
step
	.requires quest,11108
	>> Wait for the superlong RP. Don't turn in this quest. --Time the rp
	.complete 11108,1
step << Horde
	.requires quest,9937
...
step
	...
	.complete 9819,1 --Tortured Earth Spirit Slain (x15)
step
	.requires quest,9853
	.goto Nagrand,61.2,22.2
...
step
	...
	.complete 11020,1
--not sure if this starts from aldor/scryer base or netherwing
step
...
step
	.goto Netherstorm,43.5,35.0
	+Head to the Stormspire and attack an enemy player to aggro the guards. Kill guards until you are neutral with the Consortium. You lose 125 rep a kill. Having a friend on the opposite faction will speed this up a lot.
